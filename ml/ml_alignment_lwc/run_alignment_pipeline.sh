...
# 請在 ml/ 目錄下執行：
#   cd ~/financial-agent/ml && bash ml_alignment_lwc/run_alignment_pipeline.sh
# ============================================================

set -e  # 任何步驟失敗即停止

cd "$(dirname "$0")"   # 切換到 ml_alignment_lwc/
...
echo ""
echo "🎉 Pipeline 完成！"
echo "   結果：ml_alignment_lwc/artifacts_aligned/aligned_result.txt"
echo "   圖表：ml_alignment_lwc/artifacts_aligned/domain_gap_diagnosis.png"
