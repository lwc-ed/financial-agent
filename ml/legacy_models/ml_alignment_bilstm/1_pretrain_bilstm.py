...
==========================================
使用與 gru_TL_alignment 完全相同的 aligned features（rolling z-score）
只換架構：GRU → Bi-LSTM
直接複用 gru_TL_alignment/artifacts_aligned/ 的前處理結果
"""
...
# ── 路徑設定 ──────────────────────────────────────────────────────────────────
# 前處理資料直接複用 gru_TL_alignment（features 完全相同，不重跑）
SRC_ARTIFACTS  = "../../gru_TL_alignment/artifacts_aligned"
...
print("\n📂 載入 Walmart aligned 資料（來自 gru_TL_alignment）...")
