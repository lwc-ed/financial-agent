...
from backend.features.saving_challenge.saving_challenge_model import SavingChallenge
from backend.features.web.user import User
from backend.features.wishlist.wishlist_model import Wishlist  # 🔥 照 linebot.py 一樣
